//
//  ScheduleAutomationViewModel.swift
//  ToneDown
//
...
// MARK: - Schedule Automation ViewModel
class ScheduleAutomationViewModel: NSObject, ObservableObject {
    ...
    let setupSteps = [
        SetupStep(
            number: 1,
            title: "schedule.setup.step1.title",
            description: "schedule.setup.step1.description",
            action: "schedule.setup.step1.action",
            icon: "plus.circle.fill",
            color: .green,
            video: "schedule_step1_create_automation"
        ),
        SetupStep(
            number: 2,
            title: "schedule.setup.step2.title",
            description: "schedule.setup.step2.description",
            action: "schedule.setup.step2.action",
            icon: "clock.fill",
            color: .blue,
            video: "schedule_step2_select_time"
        ),
        SetupStep(
            number: 3,
            title: "schedule.setup.step3.title",
            description: "schedule.setup.step3.description",
            action: "schedule.setup.step3.action",
            icon: "checkmark.circle.fill",
            color: .green,
            video: "schedule_step3_select_grayscale_on"
        ),
        SetupStep(
            number: 4,
            title: "schedule.setup.step4.title",
            description: "schedule.setup.step4.description",
            action: "schedule.setup.step4.action",
            icon: "plus.circle.fill",
            color: .green,
            video: "schedule_step4_create_second_automation"
        ),
        SetupStep(
            number: 5,
            title: "schedule.setup.step5.title",
            description: "schedule.setup.step5.description",
            action: "schedule.setup.step5.action",
            icon: "clock.fill",
            color: .orange,
            video: "schedule_step5_select_off_time"
        ),
        SetupStep(
            number: 6,
            title: "schedule.setup.step6.title",
            description: "schedule.setup.step6.description",
            action: "schedule.setup.step6.action",
            icon: "xmark.circle.fill",
            color: .red,
            video: "schedule_step6_select_grayscale_off"
        ),
        SetupStep(
            number: 7,
            title: "schedule.setup.step7.title",
            description: "schedule.setup.step7.description",
            action: "schedule.setup.step7.action",
            icon: "play.circle.fill",
            color: .blue,
            video: "schedule_step7_test_automation"
        )
    ]
