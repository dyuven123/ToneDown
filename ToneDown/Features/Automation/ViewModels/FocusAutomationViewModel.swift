//
//  FocusAutomationViewModel.swift
//  ToneDown
//
...
// MARK: - Focus Automation ViewModel
class FocusAutomationViewModel: NSObject, ObservableObject {
    ...
    let setupSteps = [
        SetupStep(
            number: 1,
            title: "focus.setup.step1.title",
            description: "focus.setup.step1.description",
            action: "focus.setup.step1.action",
            icon: "plus.circle.fill",
            color: .green,
            video: "focus_step1_create_automation"
        ),
        SetupStep(
            number: 2,
            title: "focus.setup.step2.title",
            description: "focus.setup.step2.description",
            action: "focus.setup.step2.action",
            icon: "moon.fill",
            color: .purple,
            video: "focus_step2_select_focus"
        ),
        SetupStep(
            number: 3,
            title: "focus.setup.step3.title",
            description: "focus.setup.step3.description",
            action: "focus.setup.step3.action",
            icon: "checkmark.circle.fill",
            color: .green,
            video: "focus_step3_select_grayscale_on"
        ),
        SetupStep(
            number: 4,
            title: "focus.setup.step4.title",
            description: "focus.setup.step4.description",
            action: "focus.setup.step4.action",
            icon: "plus.circle.fill",
            color: .green,
            video: "focus_step4_create_second_automation"
        ),
        SetupStep(
            number: 5,
            title: "focus.setup.step5.title",
            description: "focus.setup.step5.description",
            action: "focus.setup.step5.action",
            icon: "moon.fill",
            color: .orange,
            video: "focus_step5_select_focus_off"
        ),
        SetupStep(
            number: 6,
            title: "focus.setup.step6.title",
            description: "focus.setup.step6.description",
            action: "focus.setup.step6.action",
            icon: "xmark.circle.fill",
            color: .red,
            video: "focus_step6_select_grayscale_off"
        ),
        SetupStep(
            number: 7,
            title: "focus.setup.step7.title",
            description: "focus.setup.step7.description",
            action: "focus.setup.step7.action",
            icon: "play.circle.fill",
            color: .blue,
            video: "focus_step7_test_automation"
        )
    ]
