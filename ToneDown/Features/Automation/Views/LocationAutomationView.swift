...
// MARK: - Location Automation View
struct LocationAutomationView: View {
    @StateObject private var viewModel = LocationAutomationViewModel()
    ...
    var body: some View {
        ...
        .navigationTitle(LocalizedStringKey("location.setup.title"))
