...
// MARK: - Focus Automation View
struct FocusAutomationView: View {
    @StateObject private var viewModel = FocusAutomationViewModel()
    ...
    var body: some View {
        ...
        .navigationTitle(LocalizedStringKey("focus.setup.title"))
